...
📚 Tenho me dedicado a projetos práticos envolvendo HTML, CSS, JavaScript, React, Java, Spring Boot e SQL, buscando sempre evoluir tanto no front-end quanto no back-end;<br>
